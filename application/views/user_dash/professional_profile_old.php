...
?>
                                            ...
                                            <div class="feed-box text-center">
                                                <section class="card">
                                                    <div class="card-body">
                                                        ...
                                                        <ul>
                                                            <li style="color: #000;">
                                                                <h5> <img class="align-self-center rounded-circle mr-3" style="width:22px;" alt="" src="<?php echo base_url(); ?>images/professional_profile/love.png">750</h5>
                                                            </li>
                                                            <li style="color: #000;">
                                                                <h5>265</h5>
                                                                Rating
                                                        ...
                                                        <div class="col-sm-12">
                                                            <div class="page-header float-left">
                                                                <div class="page-title">
                                                                    <h2>More Doctors in the same category...</h2>
                                                                </div>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="col-md-4">
                                                    <section class="card">
                                                        <div class="twt-feed blue-bg">
                                                            ...
                                                            <div class="media">
                                                                <a href="#">
                                                                    <img class="align-self-center rounded-circle mr-3" style="width:85px; height:85px;" alt="" src="<?php echo base_url(); ?>images/professional_profile/admin.jpg">
                                                                </a>
        ...
        <script>
            jQuery(document).ready(function(){
                localStorage.set('token', '<?php //echo $session_data['token']; ?>');
                localStorage.set('device-id', '<?php //echo $session_data['device_id']; ?>');
                localStorage.set('device-type', '<?php //echo $session_data['device_type']; ?>');
                localStorage.set('user-type', '<?php //echo $session_data['user_type']; ?>');        
            });
        </script>
