                                            ...
                                            <div class="modal-content" style="width: 60%;">
                                                ...
                                                <div class="modal-body text-left mb-2">
                                                    ...
                                                    <div>
                                                        <div class="d-flex justify-content-between">
                                                            <div>
                                                                <h6 class="text-dark font-medium font-six mb-2">Is your Service
                                                                    Available ?</h6>
                                                                <p class="text-secondary mb-0 font-medium" style="line-height: 20px;">
                                                                    Your business is
                                                                    operating in some way — even if you're only taking phone calls</p>
                                                            ...
                                                            <div class="row">
                                                                            ...
                                                                            <div class="d-flex">
                                                                                <div style="width: 100%;">
                                                                                    <label for="start-date" class="label">Start
                                                                                        Date</label>
                                                                                    <input type="text" name="start-date" class="style">
                                                                                </div>
                                                                                <div class="ml-1">
                                                                                    <i class="fa fa-clock-o set-off-time"></i>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div
                                                                            ...
                                                                            <div class="d-flex">
                                                                                <div style="width: 100%;">
                                                                                    ...
                                                                                    <input type="text" name="end-date" class="style">
                                                                                </div>
                                                                                <div class="ml-1">
                                                                                    <i class="fa fa-clock-o set-off-time"></i>
                                                                                </div>
                                                                ...
                                                                <div class="col-md-12 mb-4">
                                                                    <div>
                                                                        ...
                                                                        <input type="text" name="coupon-code" class="style">
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-12 mb-4">
                                                                    <div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-8 col-sm-8 col-md-8 col-lg-8">
                                        <h5 class="font-medium font-six" style="line-height: 20px; color: rgb(61, 61, 61);">Improve your
                                            local search ranking and help your customers with a complete profile</h5>
                                    </div>
                    ...
                    <div class="col-12 col-sm-12 col-md-6 col-lg-6">
                        ...
                        <div class="card">
                            <div class="card-body">
                                    ...
                                    <div class="custom-tab">
                                        ...
                                        <nav>
                                            <div class="nav nav-tabs d-flex justify-content-between" id="nav-tab" role="tablist">
                                                ...
                                                <a class="nav-item nav-link text-center active" id="custom-nav-home-tab"
                                                ...
                                                <a class="nav-item nav-link text-center" id="custom-nav-contact-tab" data-toggle="tab"
                                ...
                                <a href="#" class="btn btn-primary btn-sm mt-3 font-medium font-six">See more</a>
                            </div>
                        </div>
                        <!-- /Performance-->
                                        ...
                                        <div class="modal-content" style="width: 80%;">
                                            ...
                                            <div class="modal-body text-left">
                                                <div class="d-flex justify-content-between mb-3">
                                                    ...
                                                    <button class="btn btn-sm btn-primary font-medium font-six">Add Users</button>
                                                </div>
                                                <div class="d-flex mb-4">
                                                    <div>
                                                        <img src="<?php echo base_url(); ?>images/avatar/3.jpg"
                                                            style="width: 45px; height: 45px; border-radius: 50%;">
                                                    </div>
                                                    <div class="ml-3" style="width: 45%;">
                                                        <h5 style="margin-top: 13px;">(You) Abhimanyu Singh Rajput</h5>
                                                    </div>
                                                    <div style="width: 25%;">
                                                ...
                                                <div class="d-flex mb-4">
                                                    ...
                                                    <div class="ml-3" style="width: 45%;">
                                                        <h5 style="margin-top: 13px;">Abhimanyu Singh</h5>
                                                    </div>
                                                    <div style="width: 25%;">
                                                        <h6 class="font-medium" style="margin-top: 15px;">Primary Owner</h6>
                                                    </div>
                                                    ...
                                                    <div class="ml-4">
                                                        <i class="fa fa-times"
                                                            style="font-size: 18px; margin-top: 5px; padding: 8px; cursor: pointer;"></i>
                                                    </div>
                                                </div>
                                                <div class="d-flex mb-4">
                                                    <div>
                            ...
                            <div class="card-body px-2 py-3">
                                ...
                                <div class="row mt-2">
                                    <div class="col-6 col-sm-6 col-md-6 col-lg-6 pr-2"><button type="button"
                                            ...
                                            data-target="#staticModal">Add Service</button></div>
                                    <div class="col-6 col-sm-6 col-md-6 col-lg-6 pl-2 text-right"><button type="button"
                                            onclick="window.location.href='store.html'"
                                            class="btn btn-primary btn-block font-medium font-six px-2 bt-beta">Manage</button></div>
                                </div>
                            </div>
                        </div>
                        <!-- /Service Listing-->
                        ...
                        <div class="card">
                            <div class="card-body px-2 py-3">
                                ...
                                <div class="row mt-2">
                                    <div class="col-6 col-sm-6 col-md-6 col-lg-6 pr-2"><button type="button"
                                            class="btn btn-primary btn-block font-medium font-six px-2 bt-alpha" data-toggle="modal"
                                            data-target="#special-offer">Add Offer</button></div>
                                    <div class="col-6 col-sm-6 col-md-6 col-lg-6 pl-2 text-right"><button type="button"
                                            onclick="window.location.href='store.html'"
                                            class="btn btn-primary btn-block font-medium font-six px-2 bt-beta-o">Manage</button></div>
                                </div>
                            </div>
                        </div>
                        <!-- /Check Offer-->
