                        ...
                        <div class="row">
                            <div class="col-12 col-sm-12 col-md-10 col-lg-10 offset-md-1 offset-lg-1">
                                <div class="d-flex justify-content-between mt-3">
                                    <div class="">
                                        <h5 class="font-weight-bold font-large mt-2">Manage Products</h5>
                                    </div>
                                    ...
                                    <div class="custom-tab">
                                        <nav>
                                            <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                                ...
                                                <a class="nav-item nav-link" id="custom-nav-product-1-tab"
                                                    data-toggle="tab" href="#custom-nav-product-1" role="tab"
                                                    aria-controls="custom-nav-product-1" aria-selected="false">
                                                    <div class="mb-3 text-center">
                                                        <h5 class="font-six font-medium">Product-1</h5>
                                                    </div>
                                                </a>
                                                <a class="nav-item nav-link" id="custom-nav-product-2-tab"
                                                    data-toggle="tab" href="#custom-nav-product-2" role="tab"
                                                    aria-controls="custom-nav-product-2" aria-selected="false">
                                                    <div class="mb-3 text-center">
                                                        <h5 class="font-six font-medium">Product-2</h5>
                                                    </div>
                                                </a>
                                            </div>
                                        </nav>
                                ...
                                <div class="card p-3">
                                    <div class="tab-content" id="nav-tabContent">
                                        ...
                                        <div class="tab-pane fade" id="custom-nav-product-1" role="tabpanel"
                                            aria-labelledby="custom-nav-product-1-tab">
                                            <div class="row">
                                                <div class="col-12 col-sm-6 col-md-6 col-lg-4">
                                                    <div class="card">
                                                        <img class="card-img-top" src="https://i.imgur.com/hrS2McC.png"
                                        ...
                                        <div class="tab-pane fade" id="custom-nav-product-2" role="tabpanel"
                                            aria-labelledby="custom-nav-product-2-tab">
                                            <div class="row">
                                                <div class="col-12 col-sm-6 col-md-6 col-lg-4">
                                                    <div class="card">
                                                        <img class="card-img-top" src="https://i.imgur.com/hrS2McC.png"
