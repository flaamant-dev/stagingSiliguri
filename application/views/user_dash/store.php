            ...
            <?php } else { ?>
                    ...
                    <div class="col-6 col-sm-6 col-md-3 col-lg-3">                        
                        <div class="card" style="cursor: pointer;">
                            ...
                            <div class="card-body">
                                <div class="d-flex justify-content-center">
                                    <div style="width: 25px;" class="mr-2"><img
                                            src="<?php echo base_url(); ?>images/Icons/photos.png" class="img-fluid">
                                    </div>
                    ...
                    <div class="col-6 col-sm-6 col-md-3 col-lg-3">                        
                        <div class="card" style="cursor: pointer;">
                            ...
                            <div class="card-body">
                                <div class="d-flex justify-content-center">
                                    <div style="width: 25px;" class="mr-2"><img
                                            src="<?php echo base_url(); ?>images/Icons/videos.png" class="img-fluid">
                                    </div>
                    ...
                    <div class="col-6 col-sm-6 col-md-3 col-lg-3">                        
                        <div class="card" style="cursor: pointer;">
                            <div class="card-body">
                                <div class="d-flex justify-content-center">
                                    <div style="width: 25px;" class="mr-2"><img
                                            src="<?php echo base_url(); ?>images/Icons/create_ad.png" class="img-fluid">
                                    </div>
                ...
                <div class="row">
                    <div class="col-12 col-sm-12 col-md-6 col-lg-6">
                        ...
                        <div class="card">
                            <div class="card-body">
                                    ...
                                    <div class="d-flex justify-content-between">
                                        <div class="d-flex">
                                            ...
                                            <h6 class="font-medium text-primary font-six pb-2" style="cursor: pointer;"
                                                data-toggle="modal" data-target="#update-service">Update Service Availability</h6>
                                        </div>
                                        <div style="cursor: pointer;">
                                            <h6 class="font-medium"><a data-toggle="modal" data-target="#update-service"
                                                    class="text-primary new-btn">New</a>
                                            </h6>
                                        </div>
                                    </div>
                                        ...
                                        <div class="modal-dialog modal-lg" role="document"
                                            ...
                                            <div class="modal-content" style="width: 60%;">
                                                        ...
                                                        <div class="d-flex justify-content-between">
                                                            <div>
                                                                ...
                                                                <p class="text-secondary mb-0 font-medium" style="line-height: 20px;">
                                                                    Your business is
                                                                    operating in some way — even if you're only taking phone calls</p>
                                                            </div>
                                                            <div class="ml-3">
                                                                <label class="switch">
                                                ...
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-primary font-medium" data-dismiss="modal">Done</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="pt-3">
                                    <div class="d-flex justify-content-between">
                                        <div class="d-flex">
                                            <div style="width: 16px;" class="mr-2"><img src="<?php echo base_url(); ?>images/Icons/percent.png"
                                                    style="vertical-align: super;"></div>
                                            <a class="pb-2">
                                                <h6 class="font-medium text-primary font-six" style="cursor: pointer;"
                                                    data-toggle="modal" data-target="#special-offer">Special Offer</h6>
                                            </a>
                                        </div>
                                        
                                        <div class="modal fade" id="special-offer" tabindex="-1" role="dialog"
                                            aria-labelledby="special-offerLabel" aria-hidden="true">
                                            <div class="modal-dialog modal-lg" role="document"
                                                style="text-align: -webkit-center !important;">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <button type="button" class="btn btn-outline-primary mb-1 mt-2 font-medium font-six" data-toggle="modal"
                                    data-target="#review">Share
                                    review form</button>
                                    ...
                                    <div class="modal-dialog modal-lg" role="document" style="text-align: -webkit-center !important;">
                                        <div class="modal-content" style="width: 80%;">
                                            ...
                                            <div class="modal-body text-left mb-2">
                                                ...
                                                <h5 class="text-center font-medium text-secondary">Keep your customers engage for better
                                                    rich</h5>
                                                        ...
                                                        <div class="custom-tab">
                                                            ...
                                                            <nav>
                                                                <div class="nav nav-tabs text-center" id="nav-tab" role="tablist">
                                                                    <a class="nav-item nav-link active" id="custom-nav-consumer-tab"
                                                                        data-toggle="tab" href="#custom-nav-consumer" role="tab"
                                                                        aria-controls="custom-nav-consumer" aria-selected="true"
                                                                        style="width: calc(100% /2); font-size: 16px;">to your
                                                                        consumers</a>
                                                                    <a class="nav-item nav-link" id="custom-nav-new-feed-tab"
                                                                        data-toggle="tab" href="#custom-nav-new-feed" role="tab"
                                                                        aria-controls="custom-nav-new-feed" aria-selected="false"
                                                                        style="width: calc(100% /2); font-size: 16px;">share</a>
                                                                </div>
                                                            </nav>
                                                            <div class="tab-content pt-3" id="nav-tabContent">
                                                                <div class="tab-pane fade show active" id="custom-nav-consumer"
                                                                    role="tabpanel" aria-labelledby="custom-nav-consumer-tab">
                                                                    <span class="text-center font-large font-six">Send your consumers a
                                                                        notification</span>
                                                                    <button class="btn btn-sm btn-success">Send</button>
                                                                </div>
                
                                                                <div class="tab-pane fade" id="custom-nav-new-feed" role="tabpanel"
                                                                    aria-labelledby="custom-nav-new-feed-tab">
                                                                    <form method="post">
                                                                        <div class="row">
                                                                            <div class="col-12 mb-3">
                                                                                <div style="position: relative;">
                                                                                    <label for="video-link"
                                                                                        class="cs-vdo-link text-primary">Share
                                                                                        link</label>
                                                                                    <input type="text" name="video-link" id="copy-link"
                                                                                        class="cu-text-vdo-link"
                                                                                        value="https://youtu.be/neV3EPgvZ3g" readonly>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </form>
                                                                    <div class="d-flex justify-content-center">
                                                                        ...
                                                                        <div class="d-flex social-container ml-3"
                                                                        ...
                                                                        <div class="d-flex social-container ml-3"
                                                                            style="cursor: pointer;" onclick="copyLink()">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <button type="button" class="btn btn-outline-primary mb-1 mt-2 font-medium font-six" data-toggle="modal"
                                    data-target="#role-mg" style="width: 30%;">Invite
                                </button>
                
                                <div class="modal fade" id="role-mg" tabindex="-1" role="dialog" aria-labelledby="role-mgLabel"
                                    aria-hidden="true">
                                    <div class="modal-dialog modal-lg" role="document" style="text-align: -webkit-center !important;">
                                        <div class="modal-content" style="width: 80%;">
                                            <div class="modal-header d-flex">
                                            ...
                                            <div class="modal-body text-left">
                                                <div class="d-flex justify-content-between mb-3">
                                                    ...
                                                    <!-- <button class="btn btn-sm btn-success font-medium font-five add_doc_button">Add Doctor</button> -->
                                                    <button class="btn btn-sm btn-primary font-medium font-five add_emp_button">Add Employee</button>
                                                </div>
                                                <div class="d-flex mb-4">
                                                    ...
                                                    <div style="width: 25%;">
                                                        <h6 class="font-medium text-secondary" style="margin-top: 15px;">
                                                            Primary Owner
                                                        </h6>
                                                    </div>
                                                </div>
                                                <!--for employee-->
                                                <div class="d-flex mb-4 emp_add_div" style="display:none !important;">
                                                    <div style="width: 20%;">
                                                        <select class="form-control font-medium">
                                                            ...
                                                            <option value="EmployDoctoree">Doctor</option>
                                                        </select>
                                                        <!-- <h6 class="font-medium" style="margin-top: 15px;">Select Role</h6> -->
                                                    </div>
                                                    <!-- <div class="text-center">
                                                    <div class="dropdown" style="margin-top: 5px;">
            
                                                        <i class="fa fa-caret-down"
                                                            style="font-size: 18px; padding: 10px; cursor: pointer;" id="user1"
                                                            data-toggle="dropdown"></i>
            
                                                        <div class="dropdown-menu" aria-labelledby="user1"
                                                            style="margin-top: 30px !important; margin-left: -120px;">
                                                    ...
                                                    <div class="ml-4 cancel_emp_div1">
                                                        <i class="fa fa-check approve_emp_div"
                                                            style="font-size: 18px; margin-top: 5px; padding: 8px; cursor: pointer; color: green;"></i>
                                                        <i class="fa fa-times cancel_emp_div"
                                                            style="font-size: 18px; margin-top: 5px; padding: 8px; cursor: pointer; color: red;"></i>
                                                    </div>
                                                </div>
                                                <!--for employee-->
                                                <?php if($employees != NULL) { 
                                                    ...
                                                    <div class="d-flex mb-4">
                                                        <div>
                                                            <img src="<?php echo $emp['profile_picture']; ?>"
                                                                style="width: 30px; height: 30px; border-radius: 50%;">
                                                        </div>
                                                        <div class="ml-3" style="width: 45%;">
                                            ...
                                            <div class="modal-footer">
                                                <div class="text-right">
                                                    <button type="button" class="btn btn-sm btn-primary" data-dismiss="modal" aria-label="Close">Done</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="col-12 col-sm-12 col-md-6 col-lg-6">
                                    ...
                                    <div class="custom-tab">
                                        ...
                                        <nav>
                                            <div class="nav nav-tabs d-flex justify-content-between" id="nav-tab" role="tablist">
                                                ...
                                                <a class="nav-item nav-link text-center active" id="custom-nav-contact-tab" data-toggle="tab"
                                                    href="#custom-nav-contact" role="tab" aria-controls="custom-nav-contact"
                                                    aria-selected="false" style="width: calc(100% /3);">
                                                    <div>Activity</div>
                                                    <div style="font-size: 18px;">62</div>
                                                </a>
                                                <a class="nav-item nav-link text-center" id="custom-nav-home-tab"
                                                    data-toggle="tab" href="#custom-nav-home" role="tab" aria-controls="custom-nav-home"
                                                    aria-selected="true" style="width: calc(100% /3);">
                                                    <div>views</div>
                                                    <div style="font-size: 18px;">75</div>
                                                </a>
                                                <a class="nav-item nav-link text-center" id="custom-nav-profile-tab" data-toggle="tab"
                                        ...
                                        <div class="tab-content" id="nav-tabContent">
                                            <div class="tab-pane fade show active" id="custom-nav-contact" role="tabpanel"
                                                aria-labelledby="custom-nav-contact-tab" style="max-height: 116px; overflow-y: scroll;">
                                                <div class="d-flex justify-content-between pb-3 pt-3"
                                                    ...
                                                    <div style="margin-top: -4px;">
                                                        <p class="mb-0">
                                                            <span class="mr-1"
                                                                style="font-size: 22px; vertical-align: middle;">75</span>
                                                ...
                                                <div class="d-flex justify-content-between pt-3 pb-3"
                                                    ...
                                                    <div style="margin-top: -4px;">
                                                        <p class="mb-0">
                                                            <span class="mr-1"
                                                                style="font-size: 22px; vertical-align: middle;">60</span>
                                                ...
                                                <div class="d-flex justify-content-between pb-3 pt-3"
                                                    style="border-bottom: 1px solid rgb(226, 226, 226);">
                                                    <div>
                                                        <span class="font-six font-medium"
                                                            style="color: rgb(61, 61, 61);">Request</span>
                                                    </div>
                                                    <div style="margin-top: -4px;">
                                                        <p class="mb-0">
                                                            <span class="mr-1"
                                                ...
                                                <div class="d-flex justify-content-between pt-3 pb-3"
                                                    ...
                                                    <div>
                                                        <span class="font-six font-medium"
                                                            style="color: rgb(61, 61, 61);">Enquiry</span>
                                                    </div>
                                                    <div style="margin-top: -4px;">
                                                        <p class="mb-0">
                                                            <span class="mr-1"
                                            ...
                                            <div class="tab-pane fade" id="custom-nav-profile" role="tabpanel"
                                                ...
                                                <div class="d-flex justify-content-between pb-3 pt-3"
                                                    ...
                                                    <div style="margin-top: -4px;">
                                                        <p class="mb-0">
                                                            <span class="mr-1"
                                                                style="font-size: 22px; vertical-align: middle;">50</span>
                                                            <!--<span><i class="fa fa-caret-up text-success mr-1" style="vertical-align: -webkit-baseline-middle;"></i></span>-->
                                                            <span><i class="fa fa-caret-down text-danger mr-1"
                                                                    style="vertical-align: -webkit-baseline-middle;"></i></span>
                                                            <!--<span class="text-success" style="font-size: 14px; vertical-align: sub;">( 21&#37; )</span>-->
                                                ...
                                                <div class="d-flex justify-content-between pt-3 pb-3">
                                                    ...
                                                    <div style="margin-top: -4px;">
                                                        <p class="mb-0">
                                                            <span class="mr-1"
                                                                style="font-size: 22px; vertical-align: middle;">42</span>
                                                            <span><i class="fa fa-caret-up text-success mr-1"
                                                                    style="vertical-align: -webkit-baseline-middle;"></i></span>
                                                            <!--<span><i class="fa fa-caret-down text-danger mr-1" style="vertical-align: -webkit-baseline-middle;"></i></span>-->
                                                            <span class="text-success" style="font-size: 14px; vertical-align: sub;">(
                        ...
                        ?>
                        <div class="card">
                            <a href="<?php echo base_url(); ?>users/review" style="text-decoration: none !important;">
                            <div class="card-body">
                                <div class="mb-3">
                                ...
                                <div class="row">
                                    <div class="col-9 col-sm-9 col-md-9 col-lg-9 pr-0">
                                        <div class="row">
                                            ...
                                            <div class="col-1 col-sm-1 col-md-1 col-lg-1 pl-0 pr-0 mar-le-star">
                                                <div class="extra-small">
                                                    <i class="fa fa-star" style="vertical-align: bottom; color: rgb(161, 161, 161);"></i>
                                                </div>
                                            </div>
                                            <div class="col-10 col-sm-10 col-md-10 col-lg-10 pl-0 pr-2 mar-le-bar">
                                                <div class="progress" style="height: 7px; margin-top: 10px;">
                                                    <div class="progress-bar bg-warning" role="progressbar" style="width: <?php echo(round(($r5*100/$count),2)); ?>%;"
                                                        aria-valuenow="<?php echo(round(($r5*100/$count),2)); ?>" aria-valuemin="0" aria-valuemax="100">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            ...
                                            <div class="col-1 col-sm-1 col-md-1 col-lg-1 pl-0 pr-0 mar-le-star">
                                                <div class="extra-small"><i class="fa fa-star"
                                                        style="vertical-align: bottom; color: rgb(161, 161, 161);"></i></div>
                                            </div>
                                            <div class="col-10 col-sm-10 col-md-10 col-lg-10 pl-0 pr-2 mar-le-bar">
                                                <div class="progress" style="height: 7px; margin-top: 10px;">
                                                    <div class="progress-bar bg-warning" role="progressbar" style="width: <?php echo(round(($r4*100/$count),2)); ?>0%;"
                                                        aria-valuenow="<?php echo(round(($r4*100/$count),2)); ?>" aria-valuemin="0" aria-valuemax="100"></div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            ...
                                            <div class="col-10 col-sm-10 col-md-10 col-lg-10 pl-0 pr-2 mar-le-bar">
                                                <div class="progress" style="height: 7px; margin-top: 10px;">
                                                    <div class="progress-bar bg-warning" role="progressbar" style="width: <?php echo(round(($r3*100/$count),2)); ?>%;"
                                                        aria-valuenow="<?php echo(round(($r3*100/$count),2)); ?>" aria-valuemin="0" aria-valuemax="100"></div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            ...
                                            <div class="col-10 col-sm-10 col-md-10 col-lg-10 pl-0 pr-2 mar-le-bar">
                                                <div class="progress" style="height: 7px; margin-top: 10px;">
                                                    <div class="progress-bar bg-warning" role="progressbar" style="width: <?php echo(round(($r2*100/$count),2)); ?>%;"
                                                        aria-valuenow="<?php echo(round(($r2*100/$count),2)); ?>" aria-valuemin="0" aria-valuemax="100"></div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            ...
                                            <div class="col-10 col-sm-10 col-md-10 col-lg-10 pl-0 pr-2 mar-le-bar">
                                                <div class="progress" style="height: 7px; margin-top: 10px;">
                                                    <div class="progress-bar bg-warning" role="progressbar" style="width: <?php echo(round(($r1*100/$count),2)); ?>%;"
                                                        aria-valuenow="<?php echo(round(($r1*100/$count),2)); ?>" aria-valuemin="0" aria-valuemax="100"></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <!--complete profile-->
                        <div class="card">
                            <a href="<?php echo base_url(); ?>users/edit_business_profile">
                            <div class="card-body">
                                <div class="mb-3">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                                ...
                                <div class="d-flex justify-content-between">
                                    ...
                                    <div class="d-flex">
                                        <div class="pr-2" style="border-right: 1px solid rgb(189, 189, 189);"><strong
                                                class="card-title"><a href="#" class="text-dark" data-toggle="modal" data-target="#product" style="vertical-align: sub;"><i
                            ...
                            <div class="card-body">
                                <table id="bootstrap-data-table-product" class="table table-striped table-bordered">
                                    <thead>
                                        <tr>
                                            <th>Product Name</th>
                                            <th>Quantity</th>
                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="d-flex justify-content-between">
                                    ...
                                    <div class="d-flex">
                                        <div class="pr-2" style="border-right: 1px solid rgb(189, 189, 189);"><strong
                                                class="card-title"><a href="#" class="text-dark" style="vertical-align: sub;"><i
                                                        class="fa fa-plus mr-1 text-success"></i><span class="font-normal">Add New</span></a></strong>
                                        </div>
                                        <div style="position: relative;">
                                            <a class="navbar-toggler pl-0 pr-0 pb-0 ml-2" data-toggle="collapse"
                                                data-target="#service-sort" aria-controls="navbarSupportedContent"
                                                aria-expanded="false" aria-label="Toggle navigation">
                                                <button type="button" class="btn text-dark"
                                                    style="background-color: lavender;">
                                                    <div class="d-flex">
                            ...
                            <div class="card-body">
                                <table id="bootstrap-data-table-service" class="table table-striped table-bordered">
                                    <thead>
                                        <tr>
                                            <th>Service Name</th>
                                            <th>No. of request</th>
                ...
                <div class="row">
                    <div class="col-12 col-sm-12 col-md-6 col-lg-3 pr-md-2 pr-lg-2">
                            ...
                            <div class="card-body px-2 py-3">
                                ...
                                <div class="row mt-2">
                                    <div class="col-6 col-sm-6 col-md-6 col-lg-6 pr-2">
                                        <button type="button" class="btn btn-primary btn-block font-medium font-six px-2"
                                            data-toggle="modal" data-target="#postfeed">Post Feed</button>
                                    </div>
                                    <div class="col-6 col-sm-6 col-md-6 col-lg-6 pl-2">
                                        <button type="button"
                                            onclick="window.location.href='<?php echo base_url(); ?>users/store'"
                                            class="btn btn-primary btn-block font-medium font-six px-2">See more</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <!--Modal of feed-->
                        <div class="modal fade" id="postfeed" tabindex="-1" role="dialog" aria-labelledby="postfeedLabel"
                            aria-hidden="true">
                            <div class="modal-dialog modal-lg" role="document">
                                <div class="modal-content">
                                    <div class="modal-header d-flex justify-content-between">
                                        ...
                                        <div class="card mb-0" style="-webkit-box-shadow: none; box-shadow: none;">
                                            <div class="card-body">
                                                <div class="custom-tab">
                                                    ...
                                                    <div class="tab-content pt-3" id="nav-tabContent">
                                                        <div class="tab-pane fade show active" id="custom-nav-instant-feed"
                                                            role="tabpanel" aria-labelledby="custom-nav-instant-feed-tab">
                                                            <div>
                                                                <div class="input-group">
                                                                    <input type="text" id="input1-group2" name="input1-group2"
                                                                        placeholder="Search your list" class="form-control">
                                                                ...
                                                                <div class="col-12 col-sm-12 col-md-4 col-lg-4">
                                                                    <div class="card selected-area">
                                                                        ...
                                                                        <div class="p-2">
                                                                            ...
                                                                            <div class="text-right">
                                                                                <i class="fa fa-chevron-circle-right text-success"
                    ...
                    <div class="col-12 col-sm-12 col-md-6 col-lg-3 px-md-2 px-lg-2">
                        ...
                        <div class="card">
                            <div class="card-body px-2 py-3">
                                ...
                                <div class="row mt-2">
                                    <div class="col-6 col-sm-6 col-md-6 col-lg-6 pr-2"><button type="button"
                                            class="btn btn-primary btn-block font-medium bt-alpha font-six px-2" data-toggle="modal"
                                            data-target="#product">Add Product</button></div>
                                    <div class="col-6 col-sm-6 col-md-6 col-lg-6 pl-2 text-right">
                                        <button type="button" onclick="window.location.href='<?php echo base_url(); ?>users/product'"
                                            class="btn btn-primary btn-block font-medium font-six px-2 bt-beta">Manage</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card">
                            <div class="card-body px-2 py-3">
                                ...
                                <div class="row mt-2">
                                    <div class="col-6 col-sm-6 col-md-6 col-lg-6 pr-2">
                                        <button type="button"
                                            class="btn btn-primary btn-block font-medium font-six px-2 bt-alpha" data-toggle="modal"
                                            data-target="#staticModal">Add Service</button>
                                        </div>
                                    <div class="col-6 col-sm-6 col-md-6 col-lg-6 pl-2 text-right">
                                        <button type="button"
                                            onclick="window.location.href='<?php echo base_url(); ?>users/service'"
                                            class="btn btn-primary btn-block font-medium font-six px-2 bt-beta">Manage</button>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-12 col-sm-12 col-md-6 col-lg-3 pl-md-2 pl-lg-2">
                        ...
                        <div class="card">
                            <div class="card-body px-2 py-3">
                                ...
                                <div class="row mt-2">
                                    <div class="col-6 col-sm-6 col-md-6 col-lg-6 pr-2">
                                        <button type="button" class="btn btn-primary btn-block font-medium font-six px-2 bt-alpha" 
                                            data-toggle="modal" data-target="#special-offer">Add Offer</button>
                                    </div>
                                    <div class="col-6 col-sm-6 col-md-6 col-lg-6 pl-2 text-right">
                                        <button type="button"
                                            onclick="window.location.href='<?php echo base_url(); ?>users/post'"
                                            class="btn btn-primary btn-block font-medium font-six px-2 bt-beta-o">Manage</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <script>
                    $('.add_emp_button').click(function(){
                        // $(".emp_add_div").show();
                        $(".emp_add_div").css({"display": ""});
                    });
                    $('.cancel_emp_div').click(function(){
                        jQuery(".emp_add_div").toggle();
                        // $(".emp_add_div").removeAttr("style").css({"display": "none !important;"});
                    });
                </script>
