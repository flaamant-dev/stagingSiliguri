...
<body>
                ...
                <div class="row">
                        ...
                        <div class="card" data-toggle="modal" data-target="#postfeed" style="cursor: pointer;">
                            <div class="card-body">
                                <div class="d-flex justify-content-center">
                                    <div style="width: 25px;" class="mr-2"><img src="<?php echo base_url(); ?>images/Icons/feed.png" class="img-fluid">
                                    </div>
                    ...
                    <div class="col-6 col-sm-6 col-md-3 col-lg-3">
                        ...
                        <div class="card" style="cursor: pointer;">
                            ...
                            <div class="card-body">
                                <div class="d-flex justify-content-center">
                                    <div style="width: 25px;" class="mr-2"><img src="<?php echo base_url(); ?>images/Icons/photos.png" class="img-fluid">
                                    </div>
                                        ...
                                        <div class="card mb-0" style="-webkit-box-shadow: none; box-shadow: none;">
                                            <div class="card-body">
                                                <div class="custom-tab">
                                                    ...
                                                    <nav>
                                                        <div class="nav nav-tabs text-center" id="nav-tab" role="tablist">
                                                            <a class="nav-item nav-link active" id="custom-nav-instant-feed-tab" data-toggle="tab" href="#custom-nav-instant-feed" role="tab" aria-controls="custom-nav-instant-feed" aria-selected="true" style="width: calc(100% /2); font-size: 16px;">Instant feed</a>
                                                            <a class="nav-item nav-link" id="custom-nav-share-link-tab" data-toggle="tab" href="#custom-nav-share-link" role="tab" aria-controls="custom-nav-share-link" aria-selected="false" style="width: calc(100% /2); font-size: 16px;">New Feed</a>
                                                        </div>
                                                    </nav>
                                                    <div class="tab-content pt-3" id="nav-tabContent">
    ...
    <script>
        jQuery(document).ready(function($) {
            ...
            (function($) {
                ...
                $('#bootstrap-data-table-product').DataTable({
                    lengthMenu: [
                        [10, 20, 50, -1],
                        [10, 20, 50, "All"]
                    ],
            ...
            (function($) {
                ...
                $('#bootstrap-data-table-service').DataTable({
                    lengthMenu: [
                        [10, 20, 50, -1],
                        [10, 20, 50, "All"]
                    ],
    ...
    <script>
        $('.style').on('focusin', function() {
            $(this).parent().find('label').addClass('text-active');
        });
        $('.style').on('focusout', function() {
            if (!this.value) {
                $(this).parent().find('label').removeClass('text-active');
            }
        });
    </script>
    ...
    <script>
        ...
        ClassicEditor
            .create(document.querySelector('#fe-be'))
            .catch(error => {
                console.error(error);
            });
        ClassicEditor
            .create(document.querySelector('#title-pd'))
            .catch(error => {
                console.error(error);
            });
        ClassicEditor
            .create(document.querySelector('#off-detail'))
            .catch(error => {
                console.error(error);
            });
        ClassicEditor
            .create(document.querySelector('#term-c'))
            .catch(error => {
                console.error(error);
            });
        ClassicEditor
            .create(document.querySelector('#post-product-desc'))
            .catch(error => {
                console.error(error);
            });
    </script>
